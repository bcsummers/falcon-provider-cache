...
def test_middleware_get(client_memcache_enabled: object) -> None:
    """Testing GET method

    Args:
        client_memcache_enabled (fixture): The test client.
    """
...
def test_middleware_get_cache_timeout(client_memcache_enabled: object) -> None:
    """Testing GET method
